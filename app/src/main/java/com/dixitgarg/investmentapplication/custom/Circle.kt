package com.dixitgarg.investmentapplication.custom
...
fun View.getBoundaries(bounds: RectF) {
    ...
    class Circle: View {
        //default values
        private val DEFAULT_STROKE_COLOR: Int = ContextCompat.getColor(context, R.color.amountYellowColor)
        private val DEFAULT_TEXT_COLOR: Int = ContextCompat.getColor(context, R.color.white)
        ...
        private val DEFAULT_MAX_VALUE: Float = 5000f
        ...
        var trackWidth: Float = DEFAULT_STROKE_WIDTH
            set(value) {
                field = value
                postInvalidate()
        ...
        private fun init(attributeSet: AttributeSet?) {
            ...
            try {
                ...
                trackWidth = attrs.getDimension(R.styleable.CircularProgressView_trackWidth, DEFAULT_STROKE_WIDTH)
                ...
                progress = attrs.getFloat(R.styleable.CircularProgressView_progress, 0f)
        ...
        override fun onDraw(canvas: Canvas?) {
            ...
            if(textEnabled) {
                val text = "₹ ${Utility.localeNumberFormatting(text ?: formatText())}"
                ...
                val c = minDimen/2
                canvas.drawText(text, bounds.centerX(), c + textBounds.height()/2, textPaint)
            }
        }
